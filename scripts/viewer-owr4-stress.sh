...
for scenario_raw in "${scenarios[@]}"; do
  ...
  OASIS7_VIEWER_EVENT_WINDOW_SIZE="$event_window_size" \
  OASIS7_VIEWER_PERF_PROBE=1 \
  OASIS7_VIEWER_PERF_PROBE_INTERVAL_SECS=1 \
  OASIS7_VIEWER_PERF_BUDGET_MS="$perf_budget_ms" \
