...
const MODULE_ID: &str = "m4.recipe.smelter.alloy_plate";
const RECIPE_EXECUTION_PLAN_EMIT_KIND: &str = "economy.recipe_execution_plan";
const RECIPE_ID: &str = "recipe.smelter.alloy_plate";
const REQUIRED_FACTORY_MARKER: &str = "smelter";
const CONSUME_PER_BATCH: &[(&str, i64)] = &[("iron_ingot", 2), ("copper_wire", 2)];
const PRODUCE_PER_BATCH: &[(&str, i64)] = &[("alloy_plate", 2)];
const BYPRODUCTS_PER_BATCH: &[(&str, i64)] = &[("slag", 1)];
const POWER_PER_BATCH: i64 = 9;
