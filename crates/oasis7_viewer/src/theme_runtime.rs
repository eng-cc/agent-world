...
const INDUSTRIAL_V3_DEFAULT_PRESET_PATH: &str =
    "crates/oasis7_viewer/assets/themes/industrial_v3/presets/industrial_v3_default.env";
const INDUSTRIAL_V3_MATTE_PRESET_PATH: &str =
    "crates/oasis7_viewer/assets/themes/industrial_v3/presets/industrial_v3_matte.env";
const INDUSTRIAL_V3_GLOSSY_PRESET_PATH: &str =
    "crates/oasis7_viewer/assets/themes/industrial_v3/presets/industrial_v3_glossy.env";

const INDUSTRIAL_V2_DEFAULT_PRESET_PATH: &str =
    "crates/oasis7_viewer/assets/themes/industrial_v2/presets/industrial_v2_default.env";
const INDUSTRIAL_V2_MATTE_PRESET_PATH: &str =
    "crates/oasis7_viewer/assets/themes/industrial_v2/presets/industrial_v2_matte.env";
const INDUSTRIAL_V2_GLOSSY_PRESET_PATH: &str =
    "crates/oasis7_viewer/assets/themes/industrial_v2/presets/industrial_v2_glossy.env";
