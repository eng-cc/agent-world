...
use super::super::{
    ActionEnvelope, EffectOrigin, GameplayContract, GameplayModuleKind, ModuleArtifact,
    ModuleEvent, ModuleEventKind, ModuleKind, ModuleLimits, ModuleManifest, ModuleRegistry,
    ModuleRole, ModuleSubscriptionStage, WorldError, WorldEvent, WorldEventBody,
};
...
impl World {
    ...
    fn validate_gameplay_activation_conflicts(
        &self,
        changes: &super::super::ModuleChangeSet,
    ) -> Result<(), WorldError> {
