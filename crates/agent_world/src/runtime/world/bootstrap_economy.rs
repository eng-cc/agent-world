use super::super::{
    m4_builtin_wasm_module_artifact_bytes, util, Manifest, ModuleActivation, ModuleChangeSet,
    ModuleKind, ModuleLimits, ModuleManifest, ModuleRegistry, ModuleRole, ProposalDecision,
    WorldError, M4_ECONOMY_MODULE_VERSION, M4_FACTORY_ASSEMBLER_MODULE_ID,
