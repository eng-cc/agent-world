...
pub use builtin_modules::{
    BuiltinModule, BuiltinModuleSandbox, M1_AGENT_DEFAULT_MODULE_VERSION,
    M1_BODY_ACTION_COST_ELECTRICITY, M1_BODY_MODULE_ID, M1_MEMORY_MAX_ENTRIES, M1_MEMORY_MODULE_ID,
    M1_MOBILITY_MODULE_ID, M1_MOVE_RULE_MODULE_ID, M1_POWER_HARVEST_BASE_PER_TICK,
    ...
    M1_POWER_STORAGE_MOVE_COST_PER_KM, M1_RADIATION_POWER_MODULE_ID, M1_SENSOR_MODULE_ID,
