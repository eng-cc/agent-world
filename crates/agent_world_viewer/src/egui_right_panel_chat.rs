...
const VIEWER_PLAYER_ID_ENV_ALIASES: &[&str] = &[VIEWER_PLAYER_ID_ENV, LEGACY_VIEWER_PLAYER_ID_ENV];
...
const VIEWER_AUTH_PUBLIC_KEY_ENV_ALIASES: &[&str] = &[
    ...
    LEGACY_VIEWER_AUTH_PUBLIC_KEY_ENV,
];
...
const VIEWER_AUTH_PRIVATE_KEY_ENV_ALIASES: &[&str] = &[
    ...
    LEGACY_VIEWER_AUTH_PRIVATE_KEY_ENV,
];
