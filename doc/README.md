...
4. 若目标模块已补齐 `design.md`，继续读模块设计总览，确认模块总体设计、分层和主链路。
5. 继续读 `doc/<module>/project.md`，确认任务拆解、PRD-ID 映射、依赖与状态。
6. 按需下钻模块子文档（`doc/<module>/**/*.md`）。
7. 对照系统测试策略：`testing-manual.md` 与 `doc/testing/prd.md`。
8. 回溯过程记录：`doc/devlog/YYYY-MM-DD.md`。
