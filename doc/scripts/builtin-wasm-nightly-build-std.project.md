...
- [x] NBS-2 项目管理文档：本文件
- [ ] NBS-3 `scripts/build-wasm-module.sh` 固化 nightly toolchain + rust-src/wasm target 准备
- [ ] NBS-4 `tools/wasm_build_suite` 接入 `-Z build-std` / `-Z build-std-features`
...
## 状态
- 当前阶段：规划完成，待实现
- 最近更新：NBS-1~NBS-2 完成（2026-02-17）
