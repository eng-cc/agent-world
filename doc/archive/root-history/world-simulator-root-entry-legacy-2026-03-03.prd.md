...
- **模块可视实体机制**：模块可通过统一 `module_visual_entities` 数据结构发布“可被渲染的新事物”，viewer 统一渲染与展示，避免按功能硬编码新实体类型。
...
- 电价与市场机制（M4.4）仍为可选后续。
- 详细设计与任务状态以 `doc/world-simulator/m4/m4-power-system.prd.md` 与 `doc/world-simulator/m4/m4-power-system.prd.project.md` 为准。
- 工业生产链与 Recipe/Product/Factory 全 WASM 化接口设计见 `doc/world-simulator/m4/m4-industrial-economy-wasm.prd.md` 与 `doc/world-simulator/m4/m4-industrial-economy-wasm.prd.project.md`。
