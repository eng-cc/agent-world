...
- [x] 输出 BMS 设计文档（`doc/world-runtime/archive/builtin-wasm-crate-split.prd.md`）
- [x] 输出 BMS 项目管理文档（`doc/world-runtime/archive/builtin-wasm-crate-split.prd.project.md`）
...
### 9. WASM 运行时激进拆分（WRS）
- [x] 输出 WRS 设计文档（`doc/world-runtime/archive/wasm-runtime-crate-split.prd.md`）
- [x] 输出 WRS 项目管理文档（`doc/world-runtime/archive/wasm-runtime-crate-split.prd.project.md`）
...
### 10. WASM 拆分后测试加固（R2）
- [x] 输出 R2 设计文档（`doc/world-runtime/archive/wasm-runtime-crate-split-phase2.prd.md`）
- [x] 输出 R2 项目管理文档（`doc/world-runtime/archive/wasm-runtime-crate-split-phase2.prd.project.md`）
- [x] R2-1 补齐 `agent_world_wasm_router` 单元测试并回归
- [x] R2-2 补齐 `agent_world_wasm_executor` 单元测试并回归

### 11. WASM 运行时激进迁移（R3）
- [x] 输出 R3 设计文档（`doc/world-runtime/archive/wasm-runtime-crate-split-phase3.prd.md`）
- [x] 输出 R3 项目管理文档（`doc/world-runtime/archive/wasm-runtime-crate-split-phase3.prd.project.md`）
- [x] R3-1 迁移 `ModuleArtifact/ModuleCache` 到 `agent_world_wasm_abi` 并回归
- [x] R3-2 迁移 `agent_world_net::ModuleArtifact` 到 ABI 统一定义并回归

### 12. WASM 运行时激进迁移（R4）
- [x] 输出 R4 设计文档（`doc/world-runtime/archive/wasm-runtime-crate-split-phase4.prd.md`）
- [x] 输出 R4 项目管理文档（`doc/world-runtime/archive/wasm-runtime-crate-split-phase4.prd.project.md`）
- [x] R4-1 迁移模块清单与变更计划类型到 `agent_world_wasm_abi` 并回归

### 13. WASM 运行时激进迁移（R5）
- [x] 输出 R5 设计文档（`doc/world-runtime/archive/wasm-runtime-crate-split-phase5.prd.md`）
- [x] 输出 R5 项目管理文档（`doc/world-runtime/archive/wasm-runtime-crate-split-phase5.prd.project.md`）
- [x] R5-1 迁移模块注册表与生命周期事件类型到 `agent_world_wasm_abi` 并回归

### 14. WASM 运行时激进迁移（R6）
- [x] 输出 R6 设计文档（`doc/world-runtime/archive/wasm-runtime-crate-split-phase6.prd.md`）
- [x] 输出 R6 项目管理文档（`doc/world-runtime/archive/wasm-runtime-crate-split-phase6.prd.project.md`）
...
### 16. WASM 运行时边界收敛（R8）
- [x] 输出 R8 设计文档（`doc/world-runtime/archive/wasm-runtime-crate-split-phase8.prd.md`）
- [x] 输出 R8 项目管理文档（`doc/world-runtime/archive/wasm-runtime-crate-split-phase8.prd.project.md`）
