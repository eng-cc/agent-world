...
### T0 文档建模
- [x] 新建设计文档：`doc/game/gameplay/gameplay-release-gap-closure-2026-02-21.md`
...
## 依赖
- `doc/game/gameplay/gameplay-release-production-closure.md`
- `doc/game/gameplay/gameplay-module-driven-production-closure.md`
- `testing-manual.md`
