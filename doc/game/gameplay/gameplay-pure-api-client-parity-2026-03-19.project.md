...
- [ ] TASK-GAMEPLAY-API-002 (`PRD-GAME-008`) [test_tier_required]: `viewer_engineer` / `runtime_engineer` 对齐协议级 canonical 玩家语义，定义 `stage / goal / progress / blocker / next_step / available_actions / recent_feedback` 的统一 schema，并消除 UI 私有必需字段。
