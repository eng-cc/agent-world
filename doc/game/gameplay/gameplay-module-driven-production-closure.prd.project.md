...
- [x] 新建项目管理文档：`doc/game/gameplay/gameplay-module-driven-production-closure.prd.project.md`
...
### T4 文档与顶层任务收口（对应问题 5）
- [x] 回写 `doc/game/gameplay/gameplay-top-level-design.prd.project.md` 未完成项
