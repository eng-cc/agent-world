# Agent World Runtime：区块链 + P2P FS 硬改造（Phase 5）项目管理文档

## 任务拆解
- [x] HP5-0：输出设计文档与项目管理文档。
- [x] HP5-1：实现 membership signer 公钥白名单策略字段与校验逻辑。
- [ ] HP5-2：补齐单测并执行回归，回写文档状态与 devlog。
