# Agent World Runtime：区块链 + P2P FS 硬改造（Phase 6）项目管理文档

## 任务拆解
- [x] HP6-0：输出设计文档与项目管理文档。
- [x] HP6-1：实现 signer 公钥白名单策略校验与规范化比较逻辑。
- [ ] HP6-2：补齐策略误配/大小写兼容单测并执行回归，回写文档状态与 devlog。
