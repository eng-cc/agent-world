# oasis7 Runtime：Node libp2p wasm32 编译兼容守卫（项目管理文档）
...
- [x] NWC-2 (PRD-P2P-MIG-104)：为 `oasis7_node` 增加 wasm32 目标兼容守卫与占位实现，修复编译失败。
...
- `crates/oasis7_node/src/libp2p_replication_network_wasm.rs`
