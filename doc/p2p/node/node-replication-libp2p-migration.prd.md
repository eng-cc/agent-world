# oasis7 Runtime：Node Replication 迁移到 libp2p 统一网络栈

- 对应设计文档: `doc/p2p/node/node-replication-libp2p-migration.design.md`
...
- User Stories: As a 维护者, I want oasis7 Runtime：Node Replication 迁移到 libp2p 统一网络栈 的需求结构化, so that implementation is auditable.
