# README P2 缺口收口：Node Replication 统一到 oasis7_net 网络栈设计
...
## 1. 设计定位
定义 Node Replication 统一到 `oasis7_net` 网络栈的 README P2 收口设计，确保节点复制路径与统一网络抽象对齐。

## 2. 设计结构
- 统一网络层：把 node replication 收敛到 `oasis7_net` 抽象。
