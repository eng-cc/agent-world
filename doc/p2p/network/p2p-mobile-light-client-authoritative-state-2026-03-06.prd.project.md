...
- [ ] TASK-P2P-MLC-002 (PRD-P2P-MLC-001) [test_tier_required]: 实现移动端 intent-only 协议字段（`tick/seq/sig`）与网关去重/幂等 ACK。
...
- 更新日期: 2026-03-06
- 当前状态: active
- 下一任务: TASK-P2P-MLC-002
- 风险提示:
  - challenge 规则与实时体验存在冲突，需要联动客户端最终性文案。
  - 快照/日志可用性会直接影响重连追平成功率。
- 说明: 本文档只维护执行计划；过程记录写入 `doc/devlog/2026-03-06.md`。
