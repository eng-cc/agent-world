...
## 任务拆解
- [x] UBR-1：完成设计文档与项目管理文档。
- [x] UBR-2：实现 `node_points` 在线挑战门槛与归一化奖励，补齐单元测试。
- [ ] UBR-3：实现 `node_points_runtime` 挑战采样接线并补齐运行时测试。
- [ ] UBR-4：执行 `test_tier_required` 回归，更新状态与 devlog 收口。
...
## 状态
- 当前阶段：UBR-1~UBR-2 已完成，UBR-3~UBR-4 待完成。
- 最近更新：2026-02-16。
