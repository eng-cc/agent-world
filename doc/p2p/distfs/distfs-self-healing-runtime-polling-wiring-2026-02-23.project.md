...
### T0 建档
- [x] 设计文档：`doc/p2p/distfs/distfs-self-healing-runtime-polling-wiring-2026-02-23.md`
- [x] 项目文档：`doc/p2p/distfs/distfs-self-healing-runtime-polling-wiring-2026-02-23.project.md`

### T1 Runtime 接线实现
- [x] 新增 Node 级副本维护配置模型与校验
- [x] 增加 Runtime 轮询状态字段与 tick 调用链接线
- [x] 增加 Node 侧本地目标执行器（网络拉取 + 本地 CAS 写入）
