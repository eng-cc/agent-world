...
### T0 建档
- [x] 设计文档：`doc/p2p/distfs/distfs-no-single-full-node-assumption-2026-02-23.md`
- [x] 项目文档：`doc/p2p/distfs/distfs-no-single-full-node-assumption-2026-02-23.project.md`
