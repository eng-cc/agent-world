...
## 任务拆解
- [x] 输出设计文档（`doc/p2p/distributed-consensus-membership-revocation-alerting-scheduler.md`）
- [x] 输出项目管理文档（本文件）
- [x] 新增吊销对账异常告警策略与结构
...
## 依赖
- `doc/p2p/distributed-consensus-membership-revocation-governance-reconcile.md`
