...
- TASK-P2P-008 进展（2026-03-07）: 已完成 `TASK-P2P-008-T1` 与 `T2` 的快照可观测子项（`slot_duration_ms`/`slot_clock_genesis_unix_ms`、wall-clock 提案门控、`last_observed_slot`/`missed_slot_count` 持久化与回归）；入站时间窗口校验与 full-tier 回归待完成。
