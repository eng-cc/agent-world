...
## 任务拆解
- [x] 输出设计文档（`doc/p2p/distributed-consensus-membership-revocation-dead-letter-replay-observability-adaptive-policy.md`）
- [x] 输出项目管理文档（本文件）
- [x] 实现回放观测聚合与策略推荐入口
- [x] 实现推荐后执行的协调调度入口
- [x] 补充策略自适应单元测试
...
## 依赖
- `doc/p2p/distributed-consensus-membership-revocation-dead-letter-replay-state-fair-scheduling.md`
