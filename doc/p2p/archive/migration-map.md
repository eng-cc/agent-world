...
### 最终活跃映射
- `doc/world-runtime/blockchain-p2pfs-hardening-phase2.md` -> `doc/p2p/blockchain/blockchain-p2pfs-hardening-phase2.md`
- `doc/world-runtime/blockchain-p2pfs-hardening-phase2.project.md` -> `doc/p2p/blockchain/blockchain-p2pfs-hardening-phase2.project.md`
...
- `doc/world-runtime/distfs-path-index-observer-bootstrap.md` -> `doc/p2p/distfs/distfs-path-index-observer-bootstrap.md`
- `doc/world-runtime/distfs-path-index-observer-bootstrap.project.md` -> `doc/p2p/distfs/distfs-path-index-observer-bootstrap.project.md`
- `doc/world-runtime/distfs-runtime-path-index.md` -> `doc/p2p/distfs/distfs-runtime-path-index.md`
- `doc/world-runtime/distfs-runtime-path-index.project.md` -> `doc/p2p/distfs/distfs-runtime-path-index.project.md`
- `doc/world-runtime/distfs-standard-file-io.md` -> `doc/p2p/distfs/distfs-standard-file-io.md`
- `doc/world-runtime/distfs-standard-file-io.project.md` -> `doc/p2p/distfs/distfs-standard-file-io.project.md`
- `doc/world-runtime/distributed-hard-split-phase7.md` -> `doc/p2p/distributed/distributed-hard-split-phase7.md`
- `doc/world-runtime/distributed-hard-split-phase7.project.md` -> `doc/p2p/distributed/distributed-hard-split-phase7.project.md`
...
- `doc/world-runtime/distributed-pos-consensus.md` -> `doc/p2p/distributed/distributed-pos-consensus.md`
- `doc/world-runtime/distributed-pos-consensus.project.md` -> `doc/p2p/distributed/distributed-pos-consensus.project.md`
- `doc/world-runtime/distributed-runtime.md` -> `doc/p2p/distributed/distributed-runtime.md`
- `doc/world-runtime/distributed-runtime.project.md` -> `doc/p2p/distributed/distributed-runtime.project.md`
- `doc/world-runtime/net-runtime-bridge-closure.md` -> `doc/p2p/network/net-runtime-bridge-closure.md`
- `doc/world-runtime/net-runtime-bridge-closure.project.md` -> `doc/p2p/network/net-runtime-bridge-closure.project.md`
- `doc/world-runtime/node-contribution-points-multi-node-closure-test.md` -> `doc/p2p/node/node-contribution-points-multi-node-closure-test.md`
- `doc/world-runtime/node-contribution-points-multi-node-closure-test.project.md` -> `doc/p2p/node/node-contribution-points-multi-node-closure-test.project.md`
- `doc/world-runtime/node-contribution-points-runtime-closure.project.md` -> `doc/p2p/node/node-contribution-points-runtime-closure.project.md`
- `doc/world-runtime/node-contribution-points.md` -> `doc/p2p/node/node-contribution-points.md`
- `doc/world-runtime/node-contribution-points.project.md` -> `doc/p2p/node/node-contribution-points.project.md`
- `doc/world-runtime/node-distfs-replication-network-closure.md` -> `doc/p2p/node/node-distfs-replication-network-closure.md`
- `doc/world-runtime/node-distfs-replication-network-closure.project.md` -> `doc/p2p/node/node-distfs-replication-network-closure.project.md`
- `doc/world-runtime/node-keypair-config-bootstrap.md` -> `doc/p2p/node/node-keypair-config-bootstrap.md`
- `doc/world-runtime/node-keypair-config-bootstrap.project.md` -> `doc/p2p/node/node-keypair-config-bootstrap.project.md`
- `doc/world-runtime/node-replication-libp2p-migration.md` -> `doc/p2p/node/node-replication-libp2p-migration.md`
- `doc/world-runtime/node-replication-libp2p-migration.project.md` -> `doc/p2p/node/node-replication-libp2p-migration.project.md`
- `doc/world-runtime/node-wasm32-libp2p-compile-guard.md` -> `doc/p2p/node/node-wasm32-libp2p-compile-guard.md`
- `doc/world-runtime/node-wasm32-libp2p-compile-guard.project.md` -> `doc/p2p/node/node-wasm32-libp2p-compile-guard.project.md`
- `doc/world-runtime/observer-sync-mode-metrics-runtime-bridge.md` -> `doc/p2p/observer/observer-sync-mode-metrics-runtime-bridge.md`
- `doc/world-runtime/observer-sync-mode-metrics-runtime-bridge.project.md` -> `doc/p2p/observer/observer-sync-mode-metrics-runtime-bridge.project.md`
- `doc/world-runtime/observer-sync-mode-observability.md` -> `doc/p2p/observer/observer-sync-mode-observability.md`
- `doc/world-runtime/observer-sync-mode-observability.project.md` -> `doc/p2p/observer/observer-sync-mode-observability.project.md`
- `doc/world-runtime/observer-sync-mode-runtime-metrics.md` -> `doc/p2p/observer/observer-sync-mode-runtime-metrics.md`
- `doc/world-runtime/observer-sync-mode-runtime-metrics.project.md` -> `doc/p2p/observer/observer-sync-mode-runtime-metrics.project.md`
- `doc/world-runtime/observer-sync-source-dht-mode.md` -> `doc/p2p/observer/observer-sync-source-dht-mode.md`
- `doc/world-runtime/observer-sync-source-dht-mode.project.md` -> `doc/p2p/observer/observer-sync-source-dht-mode.project.md`
- `doc/world-runtime/observer-sync-source-mode.md` -> `doc/p2p/observer/observer-sync-source-mode.md`
- `doc/world-runtime/observer-sync-source-mode.project.md` -> `doc/p2p/observer/observer-sync-source-mode.project.md`
