...
- `doc/world-runtime/distributed-node-mainloop.md` -> `doc/p2p/distributed-node-mainloop.md`
- `doc/world-runtime/distributed-node-mainloop.project.md` -> `doc/p2p/distributed-node-mainloop.project.md`
- `doc/world-runtime/distributed-node-pos-gossip.md` -> `doc/p2p/distributed-node-pos-gossip.md`
- `doc/world-runtime/distributed-node-pos-gossip.project.md` -> `doc/p2p/distributed-node-pos-gossip.project.md`
- `doc/world-runtime/distributed-node-pos-mainloop.md` -> `doc/p2p/distributed-node-pos-mainloop.md`
- `doc/world-runtime/distributed-node-pos-mainloop.project.md` -> `doc/p2p/distributed-node-pos-mainloop.project.md`
