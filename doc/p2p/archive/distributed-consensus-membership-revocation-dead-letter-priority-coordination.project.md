...
## 任务拆解
- [x] 输出设计文档（`doc/p2p/distributed-consensus-membership-revocation-dead-letter-priority-coordination.md`）
- [x] 输出项目管理文档（本文件）
...
## 依赖
- `doc/p2p/distributed-consensus-membership-revocation-dead-letter-replay-metrics-export.md`
