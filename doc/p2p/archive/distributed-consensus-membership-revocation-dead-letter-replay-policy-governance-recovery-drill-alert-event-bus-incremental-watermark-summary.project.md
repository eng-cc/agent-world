...
## 任务拆解
- [x] 输出设计文档（`doc/p2p/distributed/distributed-consensus-membership-revocation-dead-letter-replay-policy-governance-recovery-drill-alert-event-bus-incremental-watermark-summary.md`）
- [x] 输出项目管理文档（本文件）
- [x] 实现严格时间水位增量拉取入口
- [x] 实现 outcome 聚合汇总入口
