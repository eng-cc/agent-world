...
## 任务拆解（含 PRD-ID 映射）
- [x] 输出设计文档（`doc/p2p/distributed/distributed-consensus-membership-revocation-dead-letter-replay-policy-persistence-rollback.md`） (PRD-P2P-MIG-030)
- [x] 输出项目管理文档（本文件） (PRD-P2P-MIG-030)
- [x] 实现策略状态 store 抽象与内存/文件实现 (PRD-P2P-MIG-030)
- [x] 实现持久化推荐与回滚保护入口 (PRD-P2P-MIG-030)
- [x] 实现协同调度联动入口并补充单元测试 (PRD-P2P-MIG-030)
- [x] 完成验证并同步总文档/devlog (PRD-P2P-MIG-030)
