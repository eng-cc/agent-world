...
- [x] 新增告警恢复存储抽象与内存/文件实现 (PRD-P2P-MIG-011)
- [x] 新增 `emit_revocation_reconcile_alerts_with_recovery(...)` (PRD-P2P-MIG-011)
- [x] 新增 `run_revocation_reconcile_coordinated_with_recovery(...)` (PRD-P2P-MIG-011)
