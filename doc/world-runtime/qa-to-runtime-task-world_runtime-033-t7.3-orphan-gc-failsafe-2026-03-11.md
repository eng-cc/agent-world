...
## Inputs
- 关键文件：`doc/world-runtime/evidence/runtime-storage-gate-sample-2026-03-10.md`、`crates/agent_world/src/bin/world_chain_runtime/execution_bridge.rs`、`crates/agent_world/src/bin/world_chain_runtime/storage_metrics.rs`
