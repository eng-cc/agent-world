...
| PRD-WORLD_RUNTIME-012 | TASK-WORLD_RUNTIME-010/011/013/014 | `test_tier_required` | 角色审批、签名校验、冲突拒绝路径测试（`module_action_loop_split_part3.rs` 覆盖 release shadow/approve/apply 拒绝场景） | 安全与治理门禁 |
- Decision Log:
