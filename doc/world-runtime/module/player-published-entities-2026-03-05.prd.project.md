...
- [ ] TASK-WORLD_RUNTIME-015 (PRD-WORLD_RUNTIME-012) [test_tier_required]: 实现 profile 覆盖拒绝（包括 payload 与现状完全一致的场景）并补齐 release shadow/apply 冲突拒绝回归测试。
