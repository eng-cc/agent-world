...
## 状态
- 当前阶段：cutover 阶段二进行中（BMS-37 已完成，BMS-38 待执行）
- 最近更新：完成 BMS-37（`rule/body` 测试切换到 wasm 工件优先，2026-02-13）。
- 下一步：执行 BMS-38，下线 `sensor/mobility/memory/storage/power` 相关 builtin 测试注册与回退路径。
