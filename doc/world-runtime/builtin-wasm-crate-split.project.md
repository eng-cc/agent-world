...
## 状态
- 当前阶段：已完成（BMS-0 ~ BMS-27）
- 最近更新：完成 BMS-27（`move/visibility/transfer/body/sensor/mobility/memory/storage` 回归收口，2026-02-12）。
- 下一步：按优先级继续迁移剩余 builtin（如 `m1.power.radiation_harvest`、`m1.power.storage`）到独立 wasm crate。
