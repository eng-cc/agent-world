...
### T0 建档
- [x] 新建设计文档：`doc/headless-runtime/nonviewer-onchain-auth-protocol-hardening.md`
- [x] 新建项目管理文档：`doc/headless-runtime/nonviewer-onchain-auth-protocol-hardening.project.md`
