# Viewer 商业化发行缺口收敛 Phase 6（项目管理）

- 对应设计文档: `doc/world-simulator/viewer/viewer-commercial-release-phase6-material-variant-preview.design.md`
- 对应需求文档: `doc/world-simulator/viewer/viewer-commercial-release-phase6-material-variant-preview.prd.md`

审计轮次: 5

## 任务拆解（含 PRD-ID 映射）
- [x] VCR6-0 文档建档：设计文档 + 项目管理文档
- [x] VCR6-1 材质变体预设解析与运行时热切换（含测试）
...
- 下一步：进入下一阶段（贴图资产包热切换与主题批量预览）方案设计与任务拆解。
- 最近更新：2026-02-21。
