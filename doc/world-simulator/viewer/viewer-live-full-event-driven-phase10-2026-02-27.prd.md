...
## ROUND-002 主从口径
- 本文件为主文档（master）。
- `doc/world-simulator/viewer/viewer-live-full-event-driven-phase8-2026-02-27.prd.md` 与 `doc/world-simulator/viewer/viewer-live-full-event-driven-phase9-2026-02-27.prd.md` 为增量子文档（slave）。
