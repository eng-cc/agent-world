...
- 对应设计文档: `doc/world-simulator/viewer/viewer-commercial-release-phase3-material-style-layer.design.md`
...
- 新增环境变量（首批）：
  ...
  - `OASIS7_VIEWER_LOCATION_BASE_COLOR`
  - `OASIS7_VIEWER_LOCATION_EMISSIVE_COLOR`
  - `OASIS7_VIEWER_ASSET_BASE_COLOR`
  - `OASIS7_VIEWER_ASSET_EMISSIVE_COLOR`
  - `OASIS7_VIEWER_POWER_PLANT_BASE_COLOR`
  - `OASIS7_VIEWER_POWER_PLANT_EMISSIVE_COLOR`
  - `OASIS7_VIEWER_POWER_STORAGE_BASE_COLOR`
  - `OASIS7_VIEWER_POWER_STORAGE_EMISSIVE_COLOR`
