...
- 对应设计文档: `doc/world-simulator/viewer/viewer-industrial-visual-closure.design.md`
...
### IV0 文档与挂载
- [x] IV0.1 输出设计文档（`doc/world-simulator/viewer/viewer-industrial-visual-closure.prd.md`）
...
- `crates/oasis7_viewer/src/egui_observe_section_card.rs`
...
- 最近更新：完成 IVD（语义色板卡片 + 可开关动效 + 截图闭环 + `oasis7_viewer` 全量回归 196 tests，2026-02-14）
