...
### C3D-0 文档建模
- [x] C3D0.1 输出设计文档（`doc/world-simulator/viewer/viewer-3d-commercial-polish.prd.md`）
...
### C3D-2 材质层（缺口 2）
- [x] C3D2.1 新增材质分层配置（工业风 PBR 参数组）
- [x] C3D2.2 接入元素分块材质策略（可读性优先/质感优先）
- [x] C3D2.3 补齐材质构建与颜色差异回归测试

### C3D-3 光照层（缺口 3）
- [x] C3D3.1 接入三点光照（key/fill/rim）
- [x] C3D3.2 接入按档位阴影默认策略
