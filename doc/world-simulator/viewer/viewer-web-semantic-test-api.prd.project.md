...
- [ ] WTA-9 (PRD-WTA-R1-002) [test_tier_required]：扩展 `viewer_automation` round-1 语义步骤（`panel/module/focus_selection/material_variant`）并补齐解析/映射测试
- [ ] WTA-10 (PRD-WTA-R1-003) [test_tier_required]：执行 `agent_world_viewer` 定向回归、更新 PRD/project 状态与 devlog 收口
...
## 状态
- 当前阶段：WTA-9 执行中（round-1 补齐）
- 下一步：完成 WTA-9/WTA-10 并将 round-1 新语义写回手册示例
- 最近更新：2026-03-08（WTA-8 完成，round-1 补齐任务入列）
