...
- [ ] WTA-12 (PRD-WTA-R2-002) [test_tier_required]：扩展 `viewer_automation` round-2 语义步骤（`top_panel/locale/layout`）并补齐解析/映射测试
...
## 状态
- 当前阶段：WTA-12 执行中（round-2 语义补齐）
- 下一步：完成 WTA-12/WTA-13 并关闭 round-2
- 最近更新：2026-03-08（WTA-11 完成，round-2 任务入列）
