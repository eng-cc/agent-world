...
#### 5.1 新增/补齐配置项
```bash
OASIS7_VIEWER_VISUAL_EFFECTS=minimal|standard|enhanced
OASIS7_VIEWER_AGENT_VARIANT_PALETTE=<color1>,<color2>,<color3>,<color4>
OASIS7_VIEWER_AGENT_DIRECTION_INDICATOR=1|0
OASIS7_VIEWER_AGENT_SPEED_EFFECT=1|0
OASIS7_VIEWER_AGENT_TRAIL_ENABLED=1|0
OASIS7_VIEWER_LOCATION_RADIATION_GLOW=1|0
OASIS7_VIEWER_LOCATION_DAMAGE_VISUAL=1|0
OASIS7_VIEWER_ASSET_QUANTITY_VISUAL=1|0
OASIS7_VIEWER_ASSET_TYPE_COLOR=1|0
```
