...
- [ ] TASK-WORLD_SIMULATOR-046 (PRD-WORLD_SIMULATOR-018 / PRD-VAPUI-005) [test_tier_required]: 移除 legacy Bevy UI 测试路径，改为文本函数直测并清理遗留模块引用。
...
## 状态
- 当前阶段: TASK-WORLD_SIMULATOR-046 进行中。
- 当前任务: legacy UI 测试路径移除与 egui 单路径收口。
- 阻塞项: 无。
- 并行待办: 无。
- 最近更新: 2026-03-05 22:26 CST。
