...
- 最新完成: `TASK-WORLD_SIMULATOR-209~212`（已将 `agent_world_wasm_{sdk,abi,router,executor,store}` 的 crate name、workspace member 与目录名切到 `oasis7_wasm_*`，并同步更新 builtin wasm 模块、runtime、tests 与特性依赖声明。）
