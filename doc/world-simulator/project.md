...
- 更新日期: 2026-03-16
- 当前状态: active
- 下一任务: `PRD-WORLD_SIMULATOR-040 T1（冻结 OpenClaw 双轨 observation/action contract 与模式元数据）`
...
- 当前优先任务: `PRD-WORLD_SIMULATOR-040` 双轨 contract 建模 + `PRD-WORLD_SIMULATOR-038` parity 采证
...
- 并行待办: 真实 `OpenClaw(Local HTTP)` 单 NPC 闭环试点（T5 / experimental） + 双轨模式 contract 落地（T1/T2/T3）
