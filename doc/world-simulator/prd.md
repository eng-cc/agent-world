...
| PRD-WORLD_SIMULATOR-040 | TASK-WORLD_SIMULATOR-148/149/150/151/152 | `test_tier_required` / `test_tier_full` | `./scripts/doc-governance-check.sh` + 双模式 contract review + `headless_agent`/`player_parity` 真实 smoke + QA 对照采证 | OpenClaw 双轨模式、无 GUI 回归主链路、Viewer 旁路调试边界与默认模式策略 |
