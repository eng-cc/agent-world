...
### V2D1 地图符号层（2D）
- [ ] V2D1.1 Location 2D 地图符号（平面底板/中心点）
- [ ] V2D1.2 Agent 2D 地图符号（平面高亮标记）
- [ ] V2D1.3 2D/3D 模式切换联动（2D 显示、3D 隐藏）
...
## 状态
- 当前阶段：V2D0 已完成，进入 V2D1。
- 下一阶段：完成 V2D1 后进入 V2D2 并收口回归。
- 最近更新：完成 V2D0（2026-02-14）。
