...
- [ ] T1 (PRD-WORLD_SIMULATOR-025) [test_tier_required]: 落地 `world_chain_runtime` explorer P0 API（blocks/block/txs/tx/search）与持久化索引，并补齐 runtime/控制面契约测试。
...
- 最近更新：2026-03-07
- 当前阶段: in_progress
- 当前任务: T1（runtime explorer P0 API + 持久化索引）
- 备注: T0 已完成，后续按 T1 -> T2 顺序推进并逐任务提交。
