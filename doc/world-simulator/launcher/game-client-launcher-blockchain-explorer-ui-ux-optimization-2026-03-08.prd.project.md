...
- [x] T1 (PRD-WORLD_SIMULATOR-028) [test_tier_required]: 优化启动器区块链浏览器面板视觉层级与交互流程（概览分组、状态徽标、筛选恢复、列表-详情协同），并完成 native/web 回归。
...
- 当前阶段: completed
- 当前任务: 无
- 备注: T0/T1 已完成，`PRD-WORLD_SIMULATOR-028` 交付闭环。
