...
### IVA 产线 + 物流可视化（缺口 1、2）
- [ ] IVA.1 产线摘要：工厂/配方/制成品可视实体统计与近期产线产出
- [ ] IVA.2 物流路由：资源/电力传输路由聚合与吞吐摘要
- [ ] IVA.3 右侧面板接入工业链路区块（支持中英文）
- [ ] IVA.4 单测与回归（`agent_world_viewer`）
...
- 当前阶段：IVA（产线 + 物流）启动
- 下一阶段：完成 IVA 后进入 IVB
- 最近更新：完成 IV0 文档挂载并开始执行 IVA（2026-02-14）
