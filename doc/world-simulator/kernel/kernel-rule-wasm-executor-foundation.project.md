...
## 任务拆解
- [x] KWE-0 输出设计文档（`doc/world-simulator/kernel/kernel-rule-wasm-executor-foundation.md`）与项目管理文档（本文件）。
...
- `doc/world-simulator/kernel/kernel-rule-wasm-executor-foundation.md`
