...
## 任务拆解
- [x] KWM-0 输出设计文档（`doc/world-simulator/kernel/kernel-rule-wasm-module-governance.md`）与项目管理文档（本文件）。
...
- `doc/world-simulator/kernel/kernel-rule-wasm-module-governance.md`
