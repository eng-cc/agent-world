...
- [ ] TASK-WORLD_SIMULATOR-065 (PRD-WORLD_SIMULATOR-027) [test_tier_required]: 启动器主界面采用高频操作收口，低频配置迁移到“高级配置”弹窗，并完成 native/web 回归。
...
- 更新日期: 2026-03-08
- 当前状态: in_progress
- 当前优先任务: TASK-WORLD_SIMULATOR-065
- 并行待办: 无
- 专题映射状态: 2026-03-02 批次 9/9、2026-03-03 批次 4/4、2026-03-04 批次 7/7、2026-03-05 批次 4/4、2026-03-06 批次 6/6 已纳入模块项目管理文档；`TASK-WORLD_SIMULATOR-057/058/059/060/061/062/063/064` 已完成，`TASK-WORLD_SIMULATOR-065` 进行中。
