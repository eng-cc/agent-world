...
- [ ] TASK-WORLD_SIMULATOR-006 (PRD-WORLD_SIMULATOR-004): `world_chain_runtime` 新增转账提交接口（含请求校验、结构化响应、单元测试）。
- [ ] TASK-WORLD_SIMULATOR-007 (PRD-WORLD_SIMULATOR-005): runtime 新增主 token 账户转账动作/事件/状态更新（含 nonce anti-replay、余额约束、回归测试）。
...
- 更新日期: 2026-03-03
- 当前状态: active
- 当前优先任务: TASK-WORLD_SIMULATOR-006
