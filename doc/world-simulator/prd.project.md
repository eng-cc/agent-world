...
- [ ] TASK-WORLD_SIMULATOR-051 (PRD-WORLD_SIMULATOR-022) [test_tier_required]: 清理 launcher native 遗留状态字段与无效测试资产（字段/常量收敛 + 删除未引用旧测试文件）并完成回归。
...
## 状态
- 更新日期: 2026-03-06
- 当前状态: in_progress（`TASK-WORLD_SIMULATOR-051` 进行中）
- 当前优先任务: `TASK-WORLD_SIMULATOR-051`
- 并行待办: 无
- 专题映射状态: 2026-03-02 批次 9/9、2026-03-03 批次 4/4、2026-03-04 批次 7/7、2026-03-05 批次 4/4、2026-03-06 批次 5/5 已纳入模块项目管理文档；其中 `TASK-WORLD_SIMULATOR-050` 已完成，`TASK-WORLD_SIMULATOR-051` 进行中。
...
- 说明: 本文档仅维护 world-simulator 模块设计执行状态；过程记录在 `doc/devlog/2026-03-06.md`。
