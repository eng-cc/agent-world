...
- [ ] TASK-WORLD_SIMULATOR-015 (PRD-WORLD_SIMULATOR-006): 在 `agent_world_client_launcher` 落地链/游戏独立启动按钮、启动器打开默认拉起链、反馈入口链就绪门控，并补齐回归测试。
...
## 状态
- 更新日期: 2026-03-03
- 当前状态: active（TASK-WORLD_SIMULATOR-015 进行中）
- 当前优先任务: TASK-WORLD_SIMULATOR-015（链/游戏独立启动与反馈门控）
- 并行待办: 无
- 专题映射状态: 2026-03-02 批次 9/9、2026-03-03 批次 2/2 已纳入模块项目管理文档。
