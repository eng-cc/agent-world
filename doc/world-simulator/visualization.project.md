...
- [x] UI：选中对象状态与 trace 一键导出（Export Selection）
- [x] 导出文件：结构化 JSON（对象状态/关联事件/LLM trace）
- [x] UI 测试覆盖：导出按钮与导出文档生成
- [x] 提交到 git
...
- 最近更新：viewer 选中对象一键导出上线（状态/事件/trace JSON）（2026-02-07）
