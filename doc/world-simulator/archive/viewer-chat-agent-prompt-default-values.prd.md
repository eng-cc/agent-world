...
> 替代文档：`doc/world-simulator/viewer/viewer-chat-agent-prompt-default-values-prefill.prd.md`、`doc/world-simulator/viewer/viewer-chat-agent-prompt-default-values-inline-input.prd.md`。
