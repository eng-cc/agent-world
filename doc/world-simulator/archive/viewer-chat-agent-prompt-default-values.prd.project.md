...
> 替代文档：`doc/world-simulator/viewer/viewer-chat-agent-prompt-default-values-prefill.prd.project.md`、`doc/world-simulator/viewer/viewer-chat-agent-prompt-default-values-inline-input.prd.project.md`。

## 任务拆解（含 PRD-ID 映射）
- [x] VCPDV1 输出设计文档（`doc/world-simulator/archive/viewer-chat-agent-prompt-default-values.prd.md`）
