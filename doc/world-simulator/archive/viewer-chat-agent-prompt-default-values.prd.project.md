...
## 任务拆解（含 PRD-ID 映射）
- [x] VCPDV1 输出设计文档（`doc/world-simulator/viewer/viewer-chat-agent-prompt-default-values.md`）
...
- `doc/world-simulator/viewer/viewer-chat-agent-prompt-default-values.md`
