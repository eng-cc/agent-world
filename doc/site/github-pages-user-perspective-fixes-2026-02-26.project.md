...
- [ ] 修复顶部导航 sticky 失效问题
- [ ] 扩大移动端菜单/语言按钮点击热区
- [ ] 为菜单展开状态补齐 `aria-expanded` 同步与关联语义

### 2. 语言与性能修复
- [ ] 调整语言自动跳转完成标记写入时机（docs 路径不提前写入）
- [ ] 优化字体加载，减少英文首页不必要的外部字体请求
...
## 状态
- 当前阶段：进行中（任务 0 完成，1/2/3 待执行）
- 最近更新：完成建档与任务拆解（2026-02-26）
- 下一步：执行任务 1（导航与移动端可访问性修复）
