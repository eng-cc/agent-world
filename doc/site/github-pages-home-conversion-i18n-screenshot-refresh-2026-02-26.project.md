...
### 1. 首屏转化文案收敛（CN/EN）
- [ ] 调整 `site/index.html` 首屏与上手区文案，避免超预期承诺
- [ ] 调整 `site/en/index.html` 对应文案并与中文语义对齐
- [ ] 保持锚点与交互标记兼容

### 2. 中英文一致性校准
- [ ] 清理中文页关键区域混杂英文术语问题（保留必要专有名词）
- [ ] 校验 CN/EN section 同构与导航语义一致
...
## 状态
- 当前阶段：进行中（任务 0 已完成，任务 1/2/3/4 待完成）
- 最近更新：完成建档与基线（2026-02-26）
- 下一步：执行任务 1（首屏转化文案收敛）。
