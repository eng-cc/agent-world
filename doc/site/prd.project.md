...
- [ ] TASK-SITE-006 (PRD-SITE-002) [test_tier_required]: 同步 `site/doc/cn|en/viewer-manual.html` 语义口径（移除过时 `power_storage`，并校准自动目标语法）。
- [ ] TASK-SITE-007 (PRD-SITE-003) [test_tier_required]: 回写站点项目状态文档（release pipeline + module 主项目）并与 CI 实况对齐。
