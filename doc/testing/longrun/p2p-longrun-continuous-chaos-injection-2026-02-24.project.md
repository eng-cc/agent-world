...
## 任务拆解
- [x] C0：方案建档
  - [x] 设计文档：`doc/testing/longrun/p2p-longrun-continuous-chaos-injection-2026-02-24.md`
  - [x] 项目管理文档：`doc/testing/longrun/p2p-longrun-continuous-chaos-injection-2026-02-24.project.md`
- [x] C1：实现持续注入调度核心
