# oasis7: 基于 world_chain_runtime 的长跑脚本可用化（2026-02-28）（项目管理）
...
- [x] SOAKREACT-3 (PRD-TESTING-LONGRUN-SOAK-002/003): 改造 `p2p-longrun-soak.sh` 为可运行的 `world_chain_runtime` 脚本并保留 chaos 注入。
