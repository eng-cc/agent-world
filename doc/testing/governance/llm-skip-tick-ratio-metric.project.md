...
- [x] LLMSKIP-2 (PRD-TESTING-GOV-LLMSKIP-001/002): `oasis7_llm_agent_demo` 接入 skipped tick 计数与占比输出。
...
- [x] LLMSKIP-5 (PRD-TESTING-004): 专题文档按 strict schema 人工重写，并切换命名到 `.prd.md/.project.md`。
