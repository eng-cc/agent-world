...
- [ ] T2 (PRD-TESTING-CI-WASMHARD-001): m4/m5 hash manifest 迁移为 keyed canonical 平台 token。
- [ ] T3 (PRD-TESTING-CI-WASMHARD-001): sync 脚本启用 strict 模式并彻底禁止 legacy token 写回。
...
## 状态
- 更新日期：2026-03-06
- 当前阶段：执行中（T1 已完成，T2~T8 待实施）
- 阻塞项：无
- 下一步：执行 T2（m4/m5 keyed manifest 迁移）
