...
- [ ] TASK-ENGINEERING-014 (PRD-ENGINEERING-006): Owner-D 迁移 `doc/site/**`、`doc/readme/**`、`doc/scripts/**`、`doc/game/**`、`doc/engineering/**` 及根入口遗留文档（63 篇；当前执行子阶段 D1：先完成非根入口 60 篇，D2 再收口 3 份根入口 redirect project 文档）。
- [x] TASK-ENGINEERING-014-D1 (PRD-ENGINEERING-006): Owner-D 已完成非根入口 60 篇迁移（不含 3 份根入口 redirect project 文档）。
- [ ] TASK-ENGINEERING-014-D2 (PRD-ENGINEERING-006): Owner-D 待收口 3 份根入口 redirect project 文档（`doc/game-test.project.md`、`doc/world-runtime.project.md`、`doc/world-simulator.project.md`）。
...
- 更新日期: 2026-03-03
- 当前状态: active
- 当前完成: 8 / 12（完成协作入口冻结 + Owner-B 目录迁移 + Owner-C 全批次迁移收口 + Owner-D D1）
- 下一任务: TASK-ENGINEERING-011 / TASK-ENGINEERING-014-D2 / TASK-ENGINEERING-015（其余 Owner 并行执行并准备全量收口）
