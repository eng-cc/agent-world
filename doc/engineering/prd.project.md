...
- [ ] TASK-ENGINEERING-003 (PRD-ENGINEERING-002/003) [test_tier_required]: 建立工程门禁趋势统计（违规率、修复时长）。
...
- 当前规范补充: 已完成 `TASK-ENGINEERING-025/026`，冻结“目录按对象、文件按职责”的文档建模方案，并将专题短名统一为 `doc-structure-standard`。
