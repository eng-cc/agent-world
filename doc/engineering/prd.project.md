...
- [x] TASK-ENGINEERING-016 (PRD-ENGINEERING-008): 为 12 个模块补齐文件级 PRD 索引，并从模块入口文档建立可达引用。
- [x] TASK-ENGINEERING-017 (PRD-ENGINEERING-009): 在 `scripts/doc-governance-check.sh` 新增专题 `*.prd.md <-> *.prd.project.md` 双向互链门禁。
...
- 更新日期: 2026-03-03
- 当前状态: active
- 下一任务: TASK-ENGINEERING-018（任务测试分层显式化）
...
- 当前整改批次: R1（索引闭环 / 互链门禁 / 任务 tier 显式）待执行 TASK-ENGINEERING-018。
